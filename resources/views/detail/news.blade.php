      ...
      <div class="panel panel-info">
        ...
        <?php 
          $mobile = DB::table('products')
                ...
                ->select('products.*','pro_details.cpu','pro_details.ram','pro_details.screen','pro_details.vga','pro_details.storage','pro_details.exten_memmory','pro_details.cám','pro_details.càm','pro_details.sim','pro_details.connect','pro_details.pin','pro_details.os','pro_details.note')
            ...
            <div class="thumbnail mobile">              
              <div class="bt">
                ...
                <div class="intro pull-right">
                  ...
                  @if ($row->promó!='')
                    <li><span class="glyphicon glyphicon-ok-sign"></span>{!!$row->promó!!}</li>
                  @elseif($row->promò!='')
                    <li><span class="glyphicon glyphicon-ok-sign"></span>{!!$row->promò!!}</li>
                  @elseif ($row->promỏ!='')
                    <li><span class="glyphicon glyphicon-ok-sign"></span>{!!$row->promỏ!!}</li>
                  @endif 
              ...
              <div class="ct">
                <a href="{!!url('mobile/'.$row->id.'-'.$row->slug)!!}" title="Chi tiết">
                  ...
                  <li><strong>Camera</strong> : Trước  <i>{!!$row->cám!!}</i> Sau <i>{!!$row->càm!!}</i></li> 
