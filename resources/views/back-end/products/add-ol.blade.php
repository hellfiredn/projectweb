				      		...
				      		<div class="form-group">
				      			...
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				khuyễn mại 1 : <input type="text" name="txtpromó" id="inputtxtpromó" value="{{ old('txtpromó') }}" class="form-control" >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				khuyễn mại 2 : <input type="text" name="txtpromò" id="inputtxtpromò" value="{{ old('txtpromò') }}" class="form-control" >
					      			</div>
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				khuyễn mại 3 : <input type="text" name="txtpromỏ" id="inputtxtpromỏ" value="{{ old('txtpromỏ') }}" class="form-control" >
					      			</div>
					      		</div>				      			
				      		</div>
				      		<div class="form-group">				      			
				      			<div class="row">
					      			...
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				Gía sỉ : <input type="text" name="txttag" id="inputtag" value="{{ old('txttag') }}" class="form-control">
					      			</div>
					      		</div>				      			
				      		</div>
				      		<div class="form-group">
					      		...
					      		<div class="row">
					      			...
					      			<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					      				Webcam - Cam sau <input type="text" name="txtCám" id="inputtxtCám" value="{{ old('txtCám') }}" class="form-control" >
					      			</div>
					      			<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
					      				Cammera trước <input type="text" name="txtCàm" id="inputtxtCàm" value="{{ old('txtCàm') }}" class="form-control" >
					      			</div>
					      		</div>
					      		<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
