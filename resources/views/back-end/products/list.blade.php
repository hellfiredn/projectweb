				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-4 col-pro">
								@if ($loai !='all')
									<a href="{!!url('admin/sanpham/'.$loai.'/add')!!}" title=""><button type="button" class="btn btn-primary pull-right">Thêm Mới</button></a>
								@else
									<span style="font-size: 12px;"> Chọn danh mục để thêm sản phẩm hoặc</span>
								@endif
								<a href="{!! url('admin/import/sanpham') !!}" title=""><button type="button" class="btn btn-primary pull-right">Import từ Excel</button></a>
							</div>
						</div> 
					...
					<div class="panel-body" style="font-size: 12px;">
                        ...
                        @endif
											...
											<td>
											    <a href="{!!url('admin/sanpham/'.$row->category->name.'/edit/'.$row->id)!!}" title="Sửa"><span class="glyphicon glyphicon-edit"></span> </a>
											    <a href="{!!url('admin/sanpham/del/'.$row->id)!!}"  title="Xóa" onclick="return xacnhan('Xóa danh mục này ?')"><span class="glyphicon glyphicon-remove"></span> </a>
											</td>
										</tr>
									@endforeach								
								</tbody>
