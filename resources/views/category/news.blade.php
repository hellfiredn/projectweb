          ...
          <div class="camera_violet_skin" id="camera_wrap_1">
            <div class="img-responsive" data-thumb="images/slides/thumbs/qc1.png" data-src="images/slides/qc1.png">
                <div class="camera_caption fadeFromBottom">
                    Sắm Apple gía tốt, Du lịch châu âu. <em>Event mua hàng Apple Tại Thế Giới Di Động</em>
                </div>
            </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          <div class="panel panel-success">
            <div class="panel-body">
              ...
              <!-- hot new content -->              
                <div class="col-lg-6">
                  <img src="{!!url('uploads/news/'.$hót->images)!!}" alt="" height="200" width="100%">
                  <h3 class="title-h3"><a href="{!!url('tin-tuc/'.$hót->id.'-'.$hót->slug)!!}" title="">{!!$hót->title!!} </a></h3>
